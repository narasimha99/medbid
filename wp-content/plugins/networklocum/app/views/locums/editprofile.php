...
<form name="practicesignup" id="practicesignup"   autocomplete="off"  method="post" action="<?php echo $url;?>practices/editprofile" onsubmit="javascript:return validatepracticesignup();" enctype="multipart/form-data">
 <?php $this->display_flash(); ?>
				...
				<input type="hidden" name="data[Practice][id]" id="id" value="<?php echo $practiceobject->id;?>"/>
					...
					?>  
					  ...
					  <div class="form-group">
						  ...
						  <input type="text" class="form-control ff1" id="address" name="data[Practice][address]" value="<?php echo $practiceobject->address;?>"    title="" placeholder="Address"/>
  ...
  <div class="form-group">
						  ...
						  <input type="text" class="form-control ff1" id="city" name="data[Practice][city]" value="<?php echo $practiceobject->city;?>"    title="" placeholder="TYPE CITY NAME"/>
  ...
  <div class="form-group">
						  ...
						  <input type="text" class="form-control ff1" id="postcode" name="data[Practice][postcode]"  value="<?php echo $practiceobject->practice_code;?>"   title="" placeholder="Enter your postcode">
