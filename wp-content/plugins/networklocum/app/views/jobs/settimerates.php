...
<table id="<?php echo 'TABLEsessionday'.$i;?>" style="border:1px solid #DAA520;" width="auto"  >
	 ...
	 <input type="text" id="<?php echo 'session_date_'.$i;?>" name="session_date[<?php echo $i;?>]" value="<?php echo $sessiondate;?>" />  
		...
		<tr class='sessiontime' id='times1'> <td>Session 1 Enter session times using 24 hour notation (eg. 10:00, 18:00). <br/>  <span> Time</span> <input type="text" name="session_starttime[<?php echo $i;?>][1]" id="<?php echo 'session_starttime_'.$i.'_1';?>"  placeholder='eg: 09:00'/>	<span>Till</span> <input type="text" name="session_endtime[<?php echo $i;?>][1]" id="<?php echo 'session_endtime_'.$i.'_1';?>"  placeholder='eg: 17:00'  />  <span>Hourly rate £</span> 
<input type="text" name="hourlyrate[<?php echo $i;?>][1]" id="<?php echo 'hourlyrate_'.$i.'_1';?>" myid="<?php echo '_'.$i.'_1';?>"   onblur="gethourlyrate(<?php echo $i;?>,1)"  placeholder='eg: 80.00' /> 
