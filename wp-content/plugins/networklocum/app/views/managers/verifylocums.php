...
<tr>
<td><label for="username" class="control-label">GC number</label> </td>
...
?> 
					 ...
					 <div align="center">
							<form name="verifylocums" id="verifylocums"   autocomplete="off"  method="post" action="<?php echo $url;?>managers/verifylocums"  enctype="multipart/form-data">

						<input type="hidden" name="verifiedlocum" id="verifiedlocum" value="0"/>
						<input type="hidden" name="id" id="id" value="<?php echo $Locumobject->id;?>"/>
 
					<?php
					if( $Locumobject->verifiedlocum == 0) { ?>
