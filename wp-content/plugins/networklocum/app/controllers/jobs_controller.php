...
class JobsController extends MvcPublicController {
 ...
 /*
$this->load_model('Job');
		$objects  = $this->Job->find(array(
				'joins' =>  array(  'table' => 'wp_jobsessions',
					  	'on' => 'Job.id = Jobsession.job_id',
					  	'type' => 'LEFT JOIN',
						'alias'=>'Jobsession'
						),		
				'additional_selects' => array('Jobsession.session_date,Jobsession.session_starttime', 
