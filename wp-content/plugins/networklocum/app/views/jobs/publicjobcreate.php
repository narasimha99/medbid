				...
				<div class="col-md-8 col-md-offset-2 ">
 					<div class="bitbox1">
						<div class="aligncenter">
 						...
 						<!-- its my code -->
						<div id="datecalenderdiv"  style="text-align: left;">	
...
<input type="radio" name="onejobormultiplesessions" value="1" <?php if ($_post['onejobormultiplesessions'] == 1) echo "checked='checked'"; ?> > Post as one job <input style="margin-left:20px;" type="radio" name="onejobormultiplesessions" value="2" <?php if ($_post['onejobormultiplesessions'] == 2) echo 'checked=checked'; ?> > Post as individual sessions
